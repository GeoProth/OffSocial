<template>
  <div class="terms-of-service-container">
    ...
    <div class="terms-of-service-card">
      <p>Effective date: February 05, 2019</p>
      <h2>Welcome to Delete My Digital Life</h2>
      <p>These terms and conditions outline the rules and regulations for the use of Delete My Digital Life's Website.</p> <br>
      <span style="text-transform: capitalize;">
        Delete My Digital Life
      </span> is located at:<br>
      <address>
        3848 Harrison Blvd , Ogden<br>UT - 84405, United States<br>
      </address>
      <p>
        By accessing this website we assume you accept these terms and conditions in full. Do not continue to use Delete My Digital Life's website
      ...
      <p>
        We employ the use of cookies. By using Delete My Digital Life's website you consent to the use of cookies
        in accordance with Delete My Digital Life’s privacy policy.
      </p><p>
      ...
      <p>
        Unless otherwise stated, Delete My Digital Life and/or it’s licensors own the intellectual property rights for
        all material on Delete My Digital Life. All intellectual property rights are reserved. You may view and/or print
        pages from https://jrasm.us for your own personal use subject to restrictions set in these terms and conditions.
      </p>
      <p>You must not:</p>
      <ol>
        <li>Republish material from https://jrasm.us</li>
        <li>Sell, rent or sub-license material from https://jrasm.us</li>
        <li>Reproduce, duplicate or copy material from https://jrasm.us</li>
      </ol>
      <p>Redistribute content from Delete My Digital Life (unless content is specifically made for redistribution).</p>
      ...
      <p>
        ...
        the visibility associated with the hyperlink outweighs the absence of <a href="https://jrasm.us">
          Delete my Digital life
        </a>; and (d) where the
      ...
      <p>
        ...
        you must notify us by sending an e-mail to <a href="mailto:Gproth@mailinator.com" title="send an email to Gproth@mailinator.com">
          Gproth@mailinator.com
        </a>.
      ...
      <p>
        No use of Delete My Digital Life’s logo or other artwork will be allowed for linking absent a trademark license
        agreement.
      </p>
      <h2>Iframes</h2>
      <p>
